...
PLANTED = [
    ...
    (34, "迷わず薬草を使って。", "迷わずクスリ草を使って。",
     "用語集違反: 薬草→クスリ草"),
    # 以下 2 件は、字数・用語・禁則をどれも通ってしまう種類 (#86)。
    # 目で読めば分かるのに、1 行ずつ見る検査では見つからないもの
    (24, "経験値<COLOR:02>８５０<COLOR:00>", "経験値<COLOR:02>８５<COLOR:00>",
     "数字の取り違え: 経験値 850 → 85。字数も用語も通るが、実機では嘘の数字が出る"),
    (38, "いいえ", "いえ",
     "訳ぶれ: 同じ原文「いいえ」が id 5 と違う訳になっている (選択肢の不一致)"),
]
